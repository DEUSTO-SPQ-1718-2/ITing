...
public class Gestion_dos_nivel extends Activity{
    ...
    public void update_DB(){
        ...
        String URL_DATA = "http://192.168.56.1/phpss/insertar_reserva_newDB.php";
                ...
                new Response.Listener<String>(){
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            new MailSender("Axi", "Dorron", "Lasarte", password).execute();
    ...
    public void  recuperar_reservas(){
        ...
        String URL_DATA = "http://192.168.56.1/phpss/recuperar_reservas_newDB.php";
        System.out.println("no pasaaaaaaaa");
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_DATA,
                new Response.Listener<String>(){
                    @Override
